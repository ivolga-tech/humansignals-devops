...
- name: CLICKHOUSE_HOST
  value: {{ template "humansignals.clickhouse.fullname" . }}
...
- name: CLICKHOUSE_PASSWORD
  valueFrom:
    secretKeyRef:
      name: {{ include "humansignals.clickhouse.secretName" . }}
      key: {{ include "humansignals.clickhouse.secretPasswordKey" . }}
{{- else }}
- name: CLICKHOUSE_PASSWORD
...
*/}}
{{- define "humansignals.clickhouse.fullname" -}}
...
*/}}
{{- define "humansignals.clickhouse.createSecret" -}}
...
*/}}
{{- define "humansignals.clickhouse.secretName" -}}
{{- if .Values.externalClickhouse.existingSecret }}
    {{- .Values.externalClickhouse.existingSecret | quote -}}
{{- else -}}
    {{- printf "%s-external" (include "humansignals.clickhouse.fullname" .) -}}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "humansignals.clickhouse.secretPasswordKey" -}}
{{- if .Values.externalClickhouse.existingSecret }}
...
*/}}
{{- define "humansignals.clickhouse.image" -}}
...
*/}}
{{- define "humansignals_backup.clickhouse.image" -}}
