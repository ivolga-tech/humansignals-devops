...
| image.tag | string | `nil` | HumanSignals image tag to use (example: `release-1.35.0`). |
| image.default | string | `":release-1.42.0"` | HumanSignals default image. Do not overwrite, use `image.sha` or `image.tag` instead. |
...
| clickhouse.image.tag | string | `"22.3.13.80"` | ClickHouse image tag. Note: HumanSignals does not support all versions of ClickHouse. Please override the default only if you know what you are doing. |
...
| clickhouse.client.image.tag | string | `"22.3.13.80"` | ClickHouse image tag. Note: HumanSignals does not support all versions of ClickHouse. Please override the default only if you know what you are doing. |
